...
echo.
echo [TC] test call :getSrcWithVer "https://127.0.0.1/svn/shenxiaolong/core/shell_script/batch_env/common/tools_svn.bat" 200 myCacheFile
call :getSrcWithVer "https://127.0.0.1/svn/shenxiaolong/core/shell_script/batch_env/common/tools_svn.bat" 200 myCacheFile
