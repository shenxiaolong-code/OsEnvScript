...
echo  +++++++++ loading /home/xlshen/scratch/shell_script/bash_env/app/gdb/cuda_gdb/loadAlias_nvidia.gdb ...
...
define update_callstack
	echo /home/xlshen/scratch/shell_script/bash_env/app/gdb/cuda_gdb/loadAlias_nvidia.gdb:6 \r\n
    ! source /home/xlshen/scratch/shell_script/bash_env/app/gdb/cmds/update_callstack.sh $arg0
end
document update_callstack
    update callstack for improving readability
    file : /home/xlshen/scratch/shell_script/bash_env/app/gdb/cuda_gdb/loadAlias_nvidia.gdb
end

# ************************************************************************************************************

define rdrbt6
	echo /home/xlshen/scratch/shell_script/bash_env/app/gdb/cuda_gdb/loadAlias_nvidia.gdb:17 \r\n
...
define rdrbtcu
	echo /home/xlshen/scratch/shell_script/bash_env/app/gdb/cuda_gdb/loadAlias_nvidia.gdb:27 \r\n
...
define rdrpcu
    echo /home/xlshen/scratch/shell_script/bash_env/app/gdb/cuda_gdb/loadAlias_nvidia.gdb \r\n
