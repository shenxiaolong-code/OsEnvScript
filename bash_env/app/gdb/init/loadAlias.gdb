...
# bash_script_i
echo \r\n+++++++++ loading /home/xlshen/scratch/shell_script/bash_env/app/gdb/init/loadAlias.gdb:3 ...\r\n
...
document rinit
	reload gdb init procedure : source /home/xlshen/scratch/shell_script/bash_env/app/gdb/gdb_init.gdb
end
...
document rload
	reload the gdb alias script : source /home/xlshen/scratch/shell_script/bash_env/app/gdb/init/loadAlias.gdb
end 

define ipath
    source /home/xlshen/scratch/shell_script/bash_env/app/gdb/feature/cmds/info_path.gdb
end
document ipath
	source  /home/xlshen/scratch/shell_script/bash_env/app/gdb/feature/cmds/info_path.gdb
...
define bte
    # source /home/xlshen/scratch/shell_script/bash_env/app/gdb/feature/pretty_printer/hide_library_function_in_callstack_bt.py
    source /home/xlshen/scratch/shell_script/bash_env/app/gdb/feature/pretty_printer/enhance_callstack_bt_frame_filter.py
end
document bte
...
define bd
    source /home/xlshen/scratch/shell_script/bash_env/app/gdb/feature/cmds/show_compiler.py
...
define sxe    
    ...
    echo summary :\033[32m /home/xlshen/scratch/shell_script/bash_env/app/gdb/feature/bp/load_sx_exception_signal.gdb \033[37m
    echo \r\nif break when process exit ( windbg : sxe epr ) , run below commnad :
    echo \r\ncatch syscall exit exit_group\r\n\r\n
end
document sxe
    catch exception
    /home/xlshen/scratch/shell_script/bash_env/app/gdb/init/loadAlias.gdb:207
end
...
document sxenv
    ...
    /home/xlshen/scratch/shell_script/bash_env/app/gdb/init/loadAlias.gdb:214
end

define test
    source /home/xlshen/scratch/shell_script/bash_env/app/gdb/test/test.gdb
end
define testpy
    source /home/xlshen/scratch/shell_script/bash_env/app/gdb/test/test_python_in_gdb.py
end

define rdrtest
    rdr test 1 -o /home/xlshen/scratch/tmp/to_del/test.gdb.log
    echo \r\n /home/xlshen/scratch/shell_script/bash_env/app/gdb/test/test.gdb \r\n
end
...
define hh_replaced_by_help
   !grep -iR $arg0 /home/xlshen/scratch/shell_script/bash_env/app/gdb/test/gdbCmd.gdb
end
...
define on
    ...
    source /home/xlshen/scratch/shell_script/bash_env/app/gdb/init/mode_verbose.gdb
end
document on
...
define off
    ...
    source /home/xlshen/scratch/shell_script/bash_env/app/gdb/init/mode_quiet.gdb
end
document off
...
document bc
    ...
    /home/xlshen/scratch/shell_script/bash_env/app/gdb/feature/bp/regular_delete_breakpoint.py
end
...
define syms
    ...
    echo \r\n
    echo \r\n /home/xlshen/scratch/shell_script/bash_env/app/gdb/init/loadAlias.gdb:453\r\n
end
document syms
...
define xxt
    ...
    ! source /home/xlshen/scratch/shell_script/bash_env/app/gdb/feature/parse_cmd_output/parse_info_line.sh
...
document exepath    
    show current modules search path. TODO : /home/xlshen/scratch/shell_script/bash_env/app/gdb/init/loadAlias.gdb
end
...
define color    
    ...
    echo \033[35mr13
    printf "=0x%016lX  ", 7
    echo \r\n\033[36m/home/xlshen/scratch/shell_script/bash_env/app/gdb/init/loadAlias.gdb:752
...
source /home/xlshen/scratch/shell_script/bash_env/app/gdb/cuda_gdb/loadAlias_nvidia.gdb


echo \r\n--------- leaving /home/xlshen/scratch/shell_script/bash_env/app/gdb/init/loadAlias.gdb:891 \r\n